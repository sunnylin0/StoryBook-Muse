...
export interface MuseNotationInfoProps {
    info: NotationInfo;
    config: MuseConfig;
    clazz: string;
}

export const MuseNotationInfo: React.FC<MuseNotationInfoProps> = ({
    info,
    config,
    clazz,
...
export const MuseNotation: React.FC<MuseNotationProps> = ({
    notation
}: MuseNotationProps) => {
        let notat = notation!;
        let margin = 10;
